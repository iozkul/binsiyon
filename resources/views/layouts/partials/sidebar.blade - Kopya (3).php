            ...
            <li class="nav-item">
                ...
                <div class="collapse {{ request()->routeIs(['finance.*', 'budgets.*', 'reports.*', 'incomes.*', 'expenses.*', 'fees.*']) ? 'show' : '' }}" id="financeSubmenu">
                    <ul class="nav flex-column ps-3">
                        ...
                        @can('manage payrolls')
                            <li class="nav-item has-treeview {{ request()->is('personnel*') ? 'menu-open' : '' }}">
                                <a href="#" class="nav-link {{ request()->is('personnel*') ? 'active' : '' }}">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                            ...
                                            <a href="{{ route('personnel.employees.index') }}" class="nav-link {{ request()->routeIs('personnel.*') ? 'active' : '' }}">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Personel Listesi</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ route('personnel.payrolls.index') }}" class="nav-link {{ request()->is('personnel/payrolls*') ? 'active' : '' }}">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Bordrolar</p>
                                        </a>
                                    </li>
                            ...
                            <li class="nav-item has-treeview {{ request()->is('reports*') || request()->is('legal*') ? 'menu-open' : '' }}">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                            ...
                                            <a href="{{ route('reports.financial.summary') }}" class="nav-link {{ request()->routeIs('reports.*') ? 'active' : '' }}">
                                            <i class="far fa-circle nav-icon"></i>
