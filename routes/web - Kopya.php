...
Route::middleware(['auth', 'is_admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::get('/users', [AdminUserController::class, 'index'])->name('users.index');
    Route::get('/users/{user}/assign-package', [AdminUserController::class, 'assignPackageForm'])->name('users.assign-package.form');
...
Route::get('/confirm-account/{token}', [ConfirmationController::class, 'confirm'])->name('user.confirm');
